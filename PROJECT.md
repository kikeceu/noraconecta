...
│   ├── webhooks.routes.ts      # WhatsApp webhook endpoint (AUT-134), photo debounce accumulation (AUT-283), sendResponse con soporte mediaFirst: fotos/audio antes que texto con delay de 1500ms para orden visual (AUT-290, AUT-317), propaga buttonPayload a processMessage en ambos llamados (AUT-382)
