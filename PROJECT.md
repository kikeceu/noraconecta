...
│   │   │   │   ├── bot.repository.ts     # Prisma queries for BotSession model + wasTemplateSentInLast24h/setLastTemplateSentAt (AUT-272). setLastTemplateSentAt usa upsert en lugar de update para evitar P2025 cuando no existe sesión previa — AUT-401. Métodos ProfessionalRequestSession: upsertRequestSession, findActiveRequestSessions, findRequestSessionByRequestId, deleteRequestSession — AUT-442
