...
│   │   │   │   │   ├── professional-register.flow.ts # PROFESSIONAL_REGISTER flow (numbered category list from DB — AUT-234; structured availability: days + unified hours LLM parsing — AUT-238, AUT-249; per-day availability with differentiated schedules — AUT-321; UX improvements: warm greeting, bulleted zones list — AUT-300)
