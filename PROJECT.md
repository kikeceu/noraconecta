...
│   │   │   │   │   ├── ack-detector.helper.ts   # Detector de mensajes ACK (gracias, ok, 👍) para silencio inteligente en handlers que no esperan input del usuario (AUT-397)
