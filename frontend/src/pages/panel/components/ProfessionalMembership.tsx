...
export function ProfessionalMembership({ membership, sessionToken }: ProfessionalMembershipProps) {
  ...
  return (
    <>
    <div className={`max-w-5xl space-y-8 ${!hasActiveMembership ? 'pb-24' : ''}`}>
      <h1
      ...
      {hasActiveMembership && membership.activeMembership ? (
        ...
        <PanelCard>
          ...
          <button
            ...
            className="mt-5 w-full flex items-center justify-center gap-3 rounded-2xl py-4 text-base font-bold text-white transition-opacity hover:opacity-90 cursor-pointer"
            style={{
        ...
        <PanelCard>
          ...
          <button
            type="button"
            onClick={() => window.open('https://wa.me/5491123456789', '_blank')}
            className="mt-4 w-full flex items-center justify-center gap-3 rounded-2xl py-4 text-base font-bold text-white transition-opacity hover:opacity-90 cursor-pointer"
            style={{
              background: 'linear-gradient(135deg, #0B6E4F 0%, #059669 100%)',
              fontFamily: 'DM Sans',
              minHeight: '56px',
      ...
      {!hasActiveMembership && (
        <div
          className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] px-4 pb-4 pt-2 z-50"
          style={{ background: 'linear-gradient(to top, #F9FAFB 70%, transparent)' }}
        >
          <button
            type="button"
            onClick={() => window.open('https://wa.me/5491123456789', '_blank')}
            className="w-full flex items-center justify-center gap-2 rounded-2xl py-3.5 text-sm font-bold text-white transition-opacity hover:opacity-90 cursor-pointer"
            style={{
              background: 'linear-gradient(135deg, #0B6E4F 0%, #059669 100%)',
              fontFamily: 'DM Sans',
